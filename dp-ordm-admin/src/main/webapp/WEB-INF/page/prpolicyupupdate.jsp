...
<html>
	...
	<body>
		...
		<sf:form action="../productpolicy/update.do" method="post" enctype="multipart/form-data" >
		...
		<div class="prp">
			...
			<div>
				...
				<div style="float:left; width:215px; position:relative;">
					<input type="hidden" name="pId" class="pid" value="${policyBean.productRelationPolicy.pId}">
					<input type="text" name="productName" class="prp_t mat" value="${policyBean.productName}">
			...
			<div>
				...
				<span name="addmateriel" style="float:left;color:blue; cursor:pointer;">添加</span>
				<div class="clear"></div>
				<a class="msg"></a>
				<ul name="product_ul"  hidden="hidden">
				</ul>
			...
			<div class="materiel_div">
				...
				<div class="sure">
					<input type="button" name="createPRP" value="保存" />
