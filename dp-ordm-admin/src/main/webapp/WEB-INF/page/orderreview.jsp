...
<body>
	<div class="button_div">
		<div class="button_block">
			<input type="button" value="搜索" class="search_checked" href="../orderadm/searchReviewOrder" />
			...
			<tbody>
				<c:forEach items="${OrderBeanList}" var="ob" varStatus="s">
					<tr name="table_body" title="双击显示明细">
						...
						<td>
							<div href='../orderadm/orderInvalid' class="order_invalid" style="color: red">作废</div>
						</td>
						<td>${ob.orderNo}</td>
	...
	<div class="pagination_div">
		<a hidden="hidden" name="paginationURL">../orderadm/reviewOrderPage</a>
