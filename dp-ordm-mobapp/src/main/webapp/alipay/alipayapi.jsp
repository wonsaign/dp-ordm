...
<html>
	...
	<%
		...
		// FIXME: 添加外部可用域名
		sParaTemp.put("notify_url", "https://api.drplant.com.cn/dp-ordm/"+AlipayConfig.notify_url);
		sParaTemp.put("return_url", "https://api.drplant.com.cn/dp-ordm/"+AlipayConfig.return_url);
