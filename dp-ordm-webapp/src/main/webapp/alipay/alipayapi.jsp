...
<html>
	...
	<%
		...
		// FIXME: 添加外部可用域名
		sParaTemp.put("notify_url", "http://d.drplant.com.cn/dp-ordm/"+AlipayConfig.notify_url);
		sParaTemp.put("return_url", "http://d.drplant.com.cn/dp-ordm/"+AlipayConfig.return_url);
		...
		//sParaTemp.put("it_b_pay", "30m");// 订单超时时间
