...
public class CartBean  {
	...
	public CartBean(CartDetailDesc cartDetailDesc,int status){
		this.cartDetailDesc = cartDetailDesc;
		this.status=status;
	}
	...
	public CartDetailDesc getCartDetailDesc() {
		return cartDetailDesc;
	}

	public void setCartDetailDesc(CartDetailDesc cartDetailDesc) {
		this.cartDetailDesc = cartDetailDesc;
	}
