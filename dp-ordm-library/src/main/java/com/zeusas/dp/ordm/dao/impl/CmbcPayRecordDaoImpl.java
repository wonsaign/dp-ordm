 ...
 */
@Repository
public class CmbcPayRecordDaoImpl extends CoreBasicDao<CmbcPayRecord, String> implements CmbcPayRecordDao {

	static Logger logger = LoggerFactory.getLogger(CmbcPayRecordDaoImpl.class);
	@Autowired
	private OpLoggerService bizLogger;
	
	public void save(CmbcPayRecord cmbcPR) {
		Session sess = null;
	...
	@Override
	public void buildK3Receive(String orderNo, double paymenprice, Integer fCustomer)
			throws DaoException {
		DataSource ds = (DataSource) AppContext.getBean("k3");
		Connection conn = null;
		String sql = "{call dbo.f_sp_ZFCMBCReceive (?,?,?)}";
